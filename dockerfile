...
# Copie les certificats SSL obtenus localement dans le répertoire approprié
COPY ./certs/fullchain.pem /var/www/.postgresql/root.crt
COPY ./certs/privkey.pem /var/www/.postgresql/privkey.pem
